...
$licenseReference = Import-CSV $env:TEMP\SKU_Product_Names.csv | group -AsHashTable -Property GUID
...
# Output to screen
$subscribedSku | Select-Object SkuPartNumber,TotalQty,Consumed,Available,Description | ft -AutoSize
